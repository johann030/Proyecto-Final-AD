...
public class VistaConsolaBD implements IVistaBD {

	private static final Logger logger = LogManager.getLogger(VistaConsolaBD.class);

	private reader reader;

	public VistaConsolaBD() {
		reader = new reader();
	}
	...
	public Alumno insertarAlumno() {
		...
		try {
			...
			return new Alumno(nia, nombre, apellidos, genero, nacimiento, ciclo, curso, id_grupo);
		} catch (Exception e) {
	...
	public Grupo insertarGrupo() {
		...
		try {
			...
			return new Grupo(id, nombre, aula);
		} catch (Exception e) {
